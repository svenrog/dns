...
namespace DNS.Client
{
    public class ClientRequest : IRequest
    {
        ...
        public int Id
        { get => _request.Id; set => _request.Id = value;
        }
        ...
        { get => _request.OperationCode; set => _request.OperationCode = value;
        }

        public bool RecursionDesired
        { get => _request.RecursionDesired; set => _request.RecursionDesired = value;
        }
