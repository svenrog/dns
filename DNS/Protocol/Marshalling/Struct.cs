...
namespace DNS.Protocol.Marshalling
{
    public static class Struct
    {
        ...
        private static byte[] ConvertEndian<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.NonPublicFields)] T>(byte[] data)
        {
            Type type = typeof(T);
...
#pragma warning restore S3011 // Reflection should not be used to increase accessibility of classes, methods, or fields
            ...
            {
                endian = (EndianAttribute)type.GetTypeInfo().GetCustomAttributes(typeof(EndianAttribute), false)[0];
            }
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                endian ??= (EndianAttribute)field.GetCustomAttributes(typeof(EndianAttribute), false)[0];
        ...
        public static byte[] GetBytes<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.NonPublicFields)] T>(T obj) where T : struct
        {
